...
void NuFit::toymc::run_simulation_waux(std::string outfile, std::string outfile_waux, std::map<std::string, double> simpars, unsigned int nsamples) {
	...
	file << "dom_efficiency" << "\t" << "delta_cr" << "\t" << "absorption" << "\t" << "scattering" << "\t" << "zholeice_scattering" << "\n";	
	...
	double holeice_simulated = simpars["zholeice_scattering"];
	double deltacr_simulated = simpars["delta_cr"];
//	double muon_norm_mlb_simulated = simpars["muon_norm_mlb"];

	double prior_domeff_sigma = 0.1;
	double prior_hi_sigma = 0.66;
	double prior_deltacr_sigma = 0.05; 
//	double prior_muon_norm_mlb_sigma = 0.38;
		...
		double prior_hi_mean_current = generate_truncated_normal_rv(holeice_simulated, prior_hi_sigma);
		double prior_deltacr_mean_current = generate_normal_rv(deltacr_simulated, prior_deltacr_sigma);
		//double prior_muon_norm_mlb_mean_current = generate_truncated_normal_rv(muon_norm_mlb_simulated, prior_muon_norm_mlb_sigma);
		...
		file << prior_domeff_mean_current << "\t" << prior_deltacr_mean_current << "\t" << prior_absorption_current << "\t" << prior_scattering_current << "\t" << prior_hi_mean_current << "\n";
		//file << prior_domeff_mean_current << "\t" << prior_deltacr_mean_current << "\t" << prior_absorption_current << "\t" << prior_scattering_current << "\t" << prior_muon_norm_mlb_mean_current << "\n";
		//file << prior_domeff_mean_current << "\t" << prior_deltacr_mean_current << "\n";
